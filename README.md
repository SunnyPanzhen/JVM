...
说一下 JVM 的主要组成部分及其作用？
 ...
 ![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7EE0.tmp.jpg)

JVM包含两个子系统和两个组件，两个子系统为Class loader(类装载)、Execution engine(执行引擎)；两个组件为Runtime data area(运行时数据区)、[Native](https://so.csdn.net/so/search?q=Native) Interface(本地接口)。

· Class loader(类装载)：根据给定的全限定名类名(如：java.lang.Object)	来装载class文件到Runtime data area中的method area。

· Execution engine（执行引擎）：执行classes中的指令。

· Native Interface(本地接口)：与native libraries交互，是其它编程语言交	互的接口。
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7EF1.tmp.jpg) 
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7EF2.tmp.jpg) 
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7EF3.tmp.jpg) 
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7EF4.tmp.jpg) 
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7EF5.tmp.jpg) 
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7EF6.tmp.jpg) 
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7F06.tmp.jpg) 
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7F07.tmp.jpg) 
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7F08.tmp.jpg) 

***\*分代收集算法\****

当前商业虚拟机都采用分代收集的垃圾收集算法。分代收集算法，顾名思义是根据对象的存活周期将内存划分为几块。一般包括年轻代、老年代 和 永久代，如图所示：

![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7F09.tmp.jpg) 

***\*说一下 JVM 有哪些垃圾回收器？\****

如果说垃圾收集算法是内存回收的方法论，那么垃圾收集器就是内存回收的具体实现。下图展示了7种作用于不同分代的收集器，其中用于回收新生代的收集器包括Serial、PraNew、Parallel Scavenge，回收老年代的收集器包括Serial Old、Parallel Old、CMS，还有用于回收整个Java堆的G1收集器。不同收集器之间的连线表示它们可以搭配使用。

![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7F0A.tmp.jpg) 
...
![img](file:///C:\Users\Smooker\AppData\Local\Temp\ksohtml\wps7F0B.tmp.jpg) 
